...
(
	MAHD VARCHAR(7)PRIMARY KEY(MAHD),
	DATHANHTOAN BIT,
	TINHTRANGGIAO BIT,
	NGAYDAT DATETIME,
	NGAYGIAO DATETIME,
...
(
	...
	CONSTRAINT PK_CTDONDATHANG PRIMARY KEY(MAHD,MASP),
)
GO
...
(
	...
	MAHD VARCHAR(7),
	GIAMGIA DECIMAL,
	--Constraint FK_SANPHAMGG FOREIGN KEY(MASP) REFERENCES CTDONDATHANG(MASP),
	Constraint FK_MAHDD FOREIGN KEY(MAHD,MASP) REFERENCES CTDONDATHANG(MAHD,MASP),
)
GO 
